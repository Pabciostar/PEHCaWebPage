        ...
        <footer id="contact" className="bg-primary text-primary-foreground">
            <div className="container mx-auto px-4 md:px-6 py-12 md:py-24 text-center">
                ...
                <p className="mx-auto max-w-[600px] mt-4 md:text-xl">
                    Hablemos de tu proyecto. Contáctanos y hagamos que tu evento sea memorable.
                </p>
                <div className="mt-8">
                    <Button size="lg" variant="secondary" asChild>
                        <a href="https://wa.me/56944332211" target="_blank" rel="noopener noreferrer" className="inline-flex items-center">
